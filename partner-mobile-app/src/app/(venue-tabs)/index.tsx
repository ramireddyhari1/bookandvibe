...
export default function DashboardScreen() {
  ...
  async function loadDashboard() {
    try {
      const response = await apiClient.get('/partners/dashboard-stats');
      setStats(response.data?.data ?? null);
    } catch (err) {
      console.error('Failed to load dashboard stats:', err);
      setStats({ totalRevenue: 0, currentBalance: 0, activeBookings: 0, facilityCount: 0, recentTransactions: [] });
    } finally {
      setLoading(false);
      setRefreshing(false);
    }
      ...
      >
        <View style={styles.header}>
          ...
          <TouchableOpacity 
            ...
            onPress={() => router.push('/(venue-tabs)/bookings')}
          >
        ...
        <View style={styles.walletPreview}>
          ...
          <TouchableOpacity 
            ...
            onPress={() => router.push('/(venue-tabs)/earnings')}
          >
        ...
        <View style={styles.section}>
          ...
          <View style={styles.actionsGrid}>
            ...
            <TouchableOpacity 
              style={styles.actionItem}
              onPress={() => Alert.alert('Add Turf', 'New facilities must be configured via the central Admin Dashboard.')}
            >
              <View style={[styles.actionIcon, { backgroundColor: COLORS.cardLight }]}>
        ...
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            ...
            <TouchableOpacity onPress={() => router.push('/(venue-tabs)/earnings')}>
